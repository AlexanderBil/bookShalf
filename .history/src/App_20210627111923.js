...
function App() {
  ...
  const [editForm, setEditForm] = useState({}) // для компонента Edit(коли коригуєм поле)
...
// функція що заносить в стейт booksEdit, данні які ми міняєм
const handleEdit = (e) => {
    ...
    <Router>
      <main className = "container">
        <Switch>
          ...
          <Route  path = '/edit' render = {() => <Edit booksEdit = {booksEdit} deletetItem = {deletetItem} handleEdit =  />}/>
        </Switch>
      </main>
    </Router>
  </>
