  ...
  M.AutoInit();
    ...
    return (
      <div className = "column">
          ...
          <a class="waves-effect waves-light btn modal-trigger" href="#modal1">     <button data-target="modal1" onClick = {saveEditBook} className = "btn add modal-trigger"></button></a>
