...
function AddBook(props){
  ...
  const {handleSubmit, addbook, books} = props;
    ...
    return (
      <div className = "column">
          <form className = "col s12">
            ...
            <div className="input-field col s6 hide">
               <input onChange = {(e) => handleSubmit(e)} defaultValue="" name = "id" id="book-id" type="text" className="validate"/>
                 <label className="active" htmlFor="first_name2">{books.length}</label>
            </div>
          </form>
