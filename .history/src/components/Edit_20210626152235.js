      ...
      <div className = "column">
          <form className = "col s12">
            <div className="input-field col s6">
               <input defaultValue="Call of Cthulhu" name = "name" id="book-name" type="text" className="validate"/>
            ...
            <div className="input-field col s6">
               <input o defaultValue="978-3-16-148410-0" name = "isbn" id="book-isbn" type="text" className="validate"/>
