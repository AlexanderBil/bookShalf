      ...
      <div className = "column">
          <form className = "col s12">
            ...
            {(categoryDirty && categoryError) &&  <div style={{color: 'red'}}>{categoryError}</div>}
               <input onBlur = {(e) => blurHandler(e)} onChange = {(e) => {handleSubmit(e); authorHandler(e)}} value={category} name = "category" id="book-category" type="text" className="validate" required/>
