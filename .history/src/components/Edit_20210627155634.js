  ...
  M.AutoInit();
    ...
    return (
      <div className = "column">
          ...
          <button data-target="modal1" onClick = {saveEditBook} className = "btn add modal-trigger">          <a class="waves-effect waves-light btn modal-trigger" href="#modal1">Modal</a></button>
